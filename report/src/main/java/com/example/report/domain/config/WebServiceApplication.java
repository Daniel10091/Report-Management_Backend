...
@ComponentScan({"com.example.report.domain.controller, com.example.report.domain.service, com.example.report.domain.mapper, com.example.report.domain.config, com.example.report.domain.exception, com.example.report.domain.dto, com.example.report.domain.model, com.example.report.domain.repository, com.example.report.domain.util, com.example.report.domain.util.*"})
